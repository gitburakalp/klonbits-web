...
$(".header").each(function () {
  ...
  $langBtn.on("click", function () {
    $(this).closest(".lang-section").toggleClass("is-opened");
  });
      ...
      sliderConfig = {
        ...
        on: {
          transitionStart: function () {
            $(".ref-slider-block--sm").find(".slider-wrapper > *").remove();
...
$(".cards").each(function (e) {
  ...
  if (cardsMenuStatus == 0) $(this).find(".cards-menu").addClass("d-none");
...
$(".poe-img-slider").each(function () {
  $(this).append("<div class='poe-img-pagination'></div>");

  window.poeImgSlider = new Swiper($(this), {
    slidesPerView: 1,
    spaceBetween: 16,
    speed: 1000,
    loop: true,
    containerModifierClass: "poe-img-slider--",
    wrapperClass: "poe-img-wrapper",
    slideClass: "poe-img-slide",
    slideActiveClass: "poe-img-slide--active",
    slideNextClass: "poe-img-slide--next",
    slidePrevClass: "poe-img-slide--prev",
    autoplay: { delay: 5000 },
    pagination: {
      el: ".poe-img-pagination",
      type: "bullets",
      clickable: true,
    },
  });
